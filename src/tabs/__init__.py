from tabs.home_tab import build_home_tab, on_home_scroll, load_home
...
from tabs.flashcards_tab import build_flashcards_tab, load_flashcards, start_flashcards, flip_flashcard, next_flashcard, show_flashcard
